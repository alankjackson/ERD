...
# block_groups <- tigris::block_groups("IA", county = NULL)
# "https://www.google.com/maps/@?api=1&map_action=map&center=42.5399908708896%2C-92.4296092987061&zoom=13"

Title <-paste("Report for Block Group", My_blkgrp, "in", City,
              County, "county,", state)
Intro <- paste0("Data from FEMA, as of 3 Jan 2025, claims since 1978\n
               ...
               "There have been ", FEMA_data$Num_dates, " flood events."
               )  
...
Table <-
  ...
  gt() %>% 
    ...
    gtsave(paste0(Tempdir, "/Table.png")
...
Events <- foo %>% 
  ...
  geom_col() +
  coord_flip() +
  labs(title=paste("Flooding Events in Block Group", My_blkgrp),
