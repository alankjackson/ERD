...
selectInput('Depth', 'SL Rise (ft)', Depths)
...
output$map <- leaflet::renderLeaflet({
  ...
  tm_shape(dataset_blk()) +
    ...
    tm_polygons(input$Block_var, alpha=0.3,
  ...
  #   dataset() %>%  
  #     # tm_shape() +
  #   # tm_polygons("Pct_poverty", fill_alpha=0.5, # tmap 4.0
  #   tm_polygons("Pop_blk", alpha=0.5, 
  #               popup.vars=c("NAME",
  #                            "Pop_blk", 
  #                            "Fam_house_blk", 
  #                            "Wmean", 
  ...
  #     tm_shape() +
  #   # tm_polygons("Pct_poverty", fill_alpha=0.5, # tmap 4.0
  #   tm_polygons("Pct_poverty", alpha=0.5, 
  #               popup.vars=c("Blk_grp",
  #                            "Pop_at_risk", 
  #                            "Fam_hou_at_risk", 
  #                            "Mean_depth", 
...
#     Select row in table, highlight block group in map
